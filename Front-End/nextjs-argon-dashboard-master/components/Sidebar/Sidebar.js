    ...
    >
      <Container fluid>
            ...
            <DropdownToggle nav>
              <Media className="align-items-center">
                <span className="avatar avatar-sm rounded-circle">
                  <img
                    alt="..."
                    src={require("assets/img/Amortize-pics/Amortize_Logo1.svg")}
                  />
                </span>
              </Media>
            </DropdownToggle>
        ...
        <Collapse navbar isOpen={collapseOpen}>
          ...
          <hr className="my-3" />
          {/* Heading */}
          <h6 className="navbar-heading text-muted">About Company</h6>
          {/* Navigation */}
          <Nav className="mb-md-3" navbar>
            <NavItem>
              <NavLink href="getting-started.js">
                <i className="ni ni-spaceship" />
                Getting started
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="https://www.amortize.io/">
