...
async function Mint(AgentName, AgentSTXAddress) {
  ...
  await fetch('/api/offChain', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
    body: JSON.stringify({ Home: HomeAddress, StxAddress: myStxAddress()}),
  });
  ...
  //             //     'Content-Type': 'application/json',
  //             //   },
  //             //   body: JSON.stringify({ StxAddress: myStxAddress(), Address: HomeAddress.Address,
